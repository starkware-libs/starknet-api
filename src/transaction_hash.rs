...
const DECLARE: StarkFelt = StarkFelt::try_from("0x0000000000000000006465636c617265")
    .expect("Failed to create StarkFelt from value");
const DEPLOY: StarkFelt = StarkFelt::try_from("0x000000000000000000006465706c6f79")
    .expect("Failed to create StarkFelt from value");
const DEPLOY_ACCOUNT: StarkFelt = StarkFelt::try_from("0x00006465706c6f795f6163636f756e74")
    .expect("Failed to create StarkFelt from value");
const INVOKE: StarkFelt = StarkFelt::try_from("0x00000000000000000000696e766f6b65")
    .expect("Failed to create StarkFelt from value");
const L1_HANDLER: StarkFelt = StarkFelt::try_from("0x0000000000006c315f68616e646c6572")
    .expect("Failed to create StarkFelt from value");
const CONSTRUCTOR_ENTRY_POINT_SELECTOR: StarkFelt =
