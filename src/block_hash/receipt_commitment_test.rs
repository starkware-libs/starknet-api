...
fn test_receipt_hash_regression() {
    ...
    let l1_data_gas_wei_price = GasPrice(456);
    let l1_gas_wei_price = GasPrice(789);

    let expected_hash =
        StarkFelt::try_from("0x06cb27bfc55dee54e6d0fc7a6790e39f0f3c003576d50f7b8e8a1be24c351bcf")
            .unwrap();
    assert_eq!(
        calculate_receipt_hash(&transaction_receipt, l1_data_gas_wei_price, l1_gas_wei_price),
        expected_hash
    );
