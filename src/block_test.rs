...
fn block_signature_verification() {
    ...
    let block_hash =
        BlockHash(Felt::from_hex_unchecked("0x7d5db04c5ca2aea828180dc441afb1580e3cee7547a3567ced3aa5bb8b273c0"));
    let state_commitment =
        GlobalRoot(Felt::from_hex_unchecked("0x64689c12248e1110af4b3af0e2b43cd51ad13e8855f10e37669e2a4baf919c6"));
    ...
    let sequencer_pub_key = SequencerPublicKey(PublicKey(Felt::from_hex_unchecked(
