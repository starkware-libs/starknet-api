...
impl Serialize for ChainId {
    ...
    {
        match self {
            ChainId::Mainnet => serializer.serialize_str("SN_MAIN"),
            ChainId::Sepolia => serializer.serialize_str("SN_SEPOLIA"),
            ChainId::IntegrationSepolia => serializer.serialize_str("SN_INTEGRATION_SEPOLIA"),
            ChainId::Other(ref s) => serializer.serialize_str(s),
        }
    }
}
